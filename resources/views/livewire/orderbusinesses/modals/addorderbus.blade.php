    ...
    <x-slot name="content">
        ...
        <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="othermatters">
                Other Matters <x-jet-button wire:click="showAddModalMatter"> <span class="mr-2"><i class="fa fa-plus fa-lg"></i></span> Add </x-jet-button>
            </label>
                        ...
                        <div class="w-full">
                            <div class="mb-4">
                                <table class="table-auto w-full text-center">
                                    ...
                                    @endphp
                                    <tbody>
                                        @foreach($othermatterlists as $index => $othermatterlist)
                                        <tr>
                                            <td class="border p-1">{{ $count++ }}</td>
                                            <td class="border p-1">{{ $othermatterlist['othermatter_desc'] }}</td>
                                            <td class="border p-1"><x-jet-button wire:click.prevent="deleteMatter({{$index}})"> Delete </x-jet-button></td>
