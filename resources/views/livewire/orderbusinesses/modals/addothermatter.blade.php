<x-jet-dialog-modal wire:model="othermatterModal" maxWidth="2xl">
    <x-slot name="title">
        Other Matter
    </x-slot>
    ...
    <x-slot name="footer">
        <x-jet-secondary-button wire:click="$toggle('othermatterModal')" wire:loading.attr="disabled">
            Close
        </x-jet-secondary-button>

        <x-jet-button class="ml-2" wire:click="addOthermatter" wire:loading.attr="disabled">
            Add
        </x-jet-button>
    </x-slot>
</x-jet-dialog-modal>