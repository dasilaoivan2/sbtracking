<x-jet-dialog-modal wire:model="referenceModal" maxWidth="2xl">
    <x-slot name="title">
    ...
    <x-slot name="footer">
        <x-jet-secondary-button wire:click="$toggle('referenceModal')" wire:loading.attr="disabled">
            Close
        </x-jet-secondary-button>

        <x-jet-button class="ml-2" wire:click="addReference" wire:loading.attr="disabled">
            Add
        </x-jet-button>
    </x-slot>
</x-jet-dialog-modal>