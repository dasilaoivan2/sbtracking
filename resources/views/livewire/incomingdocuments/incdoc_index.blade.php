    ...
    <div class="block mr-5">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            <div class="block">
                ...
                @include('livewire.incomingdocuments.tables.incomingdocuments')

            </div>
        </div>
   

    @include('livewire.incomingdocuments.modals.adddocument')
    @include('livewire.incomingdocuments.modals.addreferral')
